...
export default function LogoReveal() {
  ...
  return (
    <DraggableItem layoutKey="logo" className="flex flex-col items-center justify-center z-20">
       <motion.img 
         ...
         className="w-[34vw] max-w-[520px] min-w-[280px] max-h-[46vh] object-contain drop-shadow-[0_0_38px_rgba(91,192,190,0.75)]"
       />
    </DraggableItem>
  );
}
