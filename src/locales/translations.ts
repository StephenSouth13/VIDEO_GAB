export const translations = {
  vi: {
    ...
    showAudioUrlPlaceholder: "Dán URL MP3/WAV/OGG hoặc upload file...",
    showAudioLoop: "Lặp",
    ...
    clearMedia: "Xóa",
    mediaSafeHint: "Upload chạy tốt trong phiên hiện tại; để deploy ổn định hãy dùng URL public hoặc file trong public.",
  ...
  en: {
    ...
    showAudioUrlPlaceholder: "Paste MP3/WAV/OGG URL or upload a file...",
    showAudioLoop: "Loop",
    ...
    clearMedia: "Clear",
    mediaSafeHint: "Uploads work for the current session; for stable deploy use a public URL or a file in public.",
